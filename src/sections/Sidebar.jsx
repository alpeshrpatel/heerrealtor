  ...
  return (
    ...
    >
      <ul className="flex flex-col gap-2 text-lg z-50">
        ...
        <li
          className="group flex justify-center items-center gap-1 lg:w-14 lg:h-14 lg:rounded-full rounded-full py-4 px-10 lg:py-4 lg:px-4 hover:w-auto hover:h-auto hover:py-4 hover:px-10  bg-[#03233F] text-white hover:text-white transition duration-300"
        ...
        <li
          className="group flex justify-center items-center gap-1 lg:w-14 lg:h-14 lg:rounded-full rounded-full py-4 px-10 lg:py-4 lg:px-4 lg:hover:w-auto lg:hover:h-auto lg:hover:py-4 lg:hover:px-10  bg-[#03233F] text-white hover:text-white transition duration-300"
          onClick={() => setIsSidebarOn(false)}
        >
        ...
        {/* <li className="group flex justify-center items-center gap-1 lg:w-14 lg:h-14 lg:rounded-full rounded-full py-4 px-10 lg:py-4 lg:px-4 lg:hover:w-auto lg:hover:h-auto lg:hover:py-4 lg:hover:px-10   bg-[#03233F] text-white hover:text-white transition duration-300" onClick={() => setIsSidebarOn(false)}>
          <a href="#mission" className="flex items-center gap-1">
            <Images />
            <span className="lg:hidden lg:group-hover:inline">Mission</span>
          </a>
        </li> */}
        {/* <li className="group flex justify-center items-center gap-1 lg:w-14 lg:h-14  lg:rounded-full rounded-full lg:hover:w-auto lg:hover:h-auto lg:hover:py-4 lg:hover:px-10 py-4 px-10 bg-[#03233F] text-[#45505b]  hover:text-white transition duration-300">
